...
def main():
    ...
    st.set_page_config(page_title = 'Telemarketing analisys', \
        page_icon = 'modulo_19_streamlit_II/Material_de_apoio_M19_Cientista_de_Dados/img/telmarketing_icon.png',
        layout="wide",
    ...
    image = Image.open("modulo_19_streamlit_II/Material_de_apoio_M19_Cientista_de_Dados/img/Bank-Branding.jpg")
